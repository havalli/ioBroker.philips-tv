        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    result = _b.apply(_a, [_c.sent()]);
                    // update muted state
                    return [4 /*yield*/, extendObject("power", {
                ...
                case 2:
                    // update muted state
                    _c.sent();
                    return [4 /*yield*/, adapter.$setStateChanged(adapter.namespace + ".power", result.powerstate === "On", true)];
                case 3:
                    _c.sent();
                    return [3 /*break*/, 5];
                case 4:
                    e_4 = _c.sent();
                    global_1.Global.log("Error fetching powerstate from tv: " + e_4.message, "error");
                    return [3 /*break*/, 5];
